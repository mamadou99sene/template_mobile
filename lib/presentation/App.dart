...
class _AppState extends State<App> {
  ...
  Future<void> _loadEvenements() async {
    final evenements = await getDons();
    setState(() {
      items = evenements;
  ...
  Future<void> _loadDonsSang() async {
    final donsSang = await getDons();
    setState(() {
      items = donsSang;
      selectedCategory = 'Dons de sang';
    });
  }
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 6.v),
                _buildItemsList(context, allUrgences),
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                _buildBottomButtonIcon(
                    "Urgences", Icons.warning, _loadUrgences),
                _buildBottomButtonIcon(
                    "Événements", Icons.event, _loadEvenements),
                _buildBottomButtonIcon(
                    "Dons de sang", Icons.favorite, _loadDonsSang),
